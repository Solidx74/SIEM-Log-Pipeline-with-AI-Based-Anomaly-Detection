...
Supports multiple protocols: HTTP, TCP, UDP, Syslog
 ...
 This script is for Linux systems only (requires systemd and the systemd-python package).
For Windows or other platforms, use the mock generator (log_generator.py).
"""
